...
export const assetColumns = <T extends { _id: string; brand: string;serial_no: string; status: string; assigned_to?: string | AssignedEmployee | null;createdAt?: Date; updatedAt?: Date; }>(
  onManage: (row: T) => void,
  onDelete: (row: T) => void
): ColumnDef<T>[] => [
  {
